...
class UIDGenerator
{
    ...
    */
    chars = new List(ascii_letters + digits)

    rnd_string(self, length=16)
    {
    ...
    uid(self, host_name='example.com', unique='')
    {
        ...
        */
        ...
        var today = to_unicode(vDatetime(datetime.today()).to_ical())
