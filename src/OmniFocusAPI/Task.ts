...
export interface Task {
    // A positional indicator that reference the list
    // position directly following this task instance.
    // const
    after: TaskChildInsertionLocation;
    ...
    // A positional indicator that references
    // the list posotion immediately preceding this task instance.
    // const
    before: TaskChildInsertionLocation;

    // A positional indicator that references
    // the very start of the task’s container object.
    // const
    ...
    // based on its local flagged and those of its containers.
    // const
    ...
    // at the very end of the task’s container object.
    // const
    ...
    // Returns a flat array of all tasks contained within this task.
    // Tasks are sorted by their order in the database.
    // This flat array is often used for processing the entire
    // task hierarchy of a specific task.
    // const
    ...
    // The list of file URLs linked to this task. The files
    // at these URLs are not present in the database, rather
    // the database holds bookmarks leading to these files.
    // These links can be read on iOS, but not written to.
    // const
    linkedFileURLs: URL[];
    ...
    // Returns all the tasks contained directly in this task,
    // sorted by their library order.
    // const
    tasks: TaskArray;
