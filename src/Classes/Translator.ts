...
export class Translator
{
    ...
    constructor() {
        ...
        this.fields.setValue(PARENT_FIELD, new RelatedTo(['related-to', 'get_parents', 'set_parent'], 'remove_parent', 'parent', null));
        this.fields.setValue(CHILDREN_FIELD,new RelatedTo(['related-to', 'get_children', 'add_child'], 'remove_child', 'child', null));
    ...
    // @classmethod
    fillTask(todo: Todo, task: Task, namespace: string)
    {
    ...
    shouldSync(task: Task, namespace: string, todo=null, vtodo=null)
    {
        for (let field of this.changed_attrs(task, namespace, todo, vtodo)) {
